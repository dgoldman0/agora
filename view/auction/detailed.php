<!-- Currently just a copy of the item detail page -->
<?
...
switch ($format)
{
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="button-toolbar" role="toobar">
							<div class="btn-group">
								<a href = "auction/bid.php?action=set&aid=" class="glyphicon glyphicon-briefcase" title="Bid on Item"></a>
							</div>
						</div>
						<hr/>
						Current Bid: <br/>
    ...
    <!-- Should the review template be removed because it's for a single item? -->
		<!--Templates-->
